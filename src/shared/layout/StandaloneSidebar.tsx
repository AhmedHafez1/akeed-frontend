...
export function StandaloneSidebar({
  ...
  return (
    <aside
      className={cn(
        'border-border flex h-full w-[248px] shrink-0 flex-col border-e bg-white px-4 py-5',
        className
      )}
    >
      <Link
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'hover:bg-muted text-slate-600 hover:text-slate-950'
              )}
            >
