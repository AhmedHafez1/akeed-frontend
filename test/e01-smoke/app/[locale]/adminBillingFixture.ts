...
const FREE_GRANT = 30
const ids = {
  fresh: '10000000-0000-4000-8000-000000000001',
  low: '10000000-0000-4000-8000-000000000002',
  spent: '10000000-0000-4000-8000-000000000003',
  suspended: '10000000-0000-4000-8000-000000000004',
  debt: '10000000-0000-4000-8000-000000000005',
}
const LOW_BALANCE_THRESHOLD = 10

function standaloneSource(orgId: string, suffix: string) {
  return {
    id: `20000000-0000-4000-8000-00000000000${suffix}`,
    identity: `standalone:${orgId}`,
...
/** Every account opened active with its launch grant at verified signup. */
const rows: Omit<CreditAccountRow, 'billing'>[] = [
  {
    orgId: ids.fresh,
    organizationName: 'New merchant with launch credits',
    source: standaloneSource(ids.fresh, '1'),
    account: accountSnapshot('active', FREE_GRANT, 0, 0),
    freeGrantPresent: true,
  },
  {
    orgId: ids.low,
    organizationName: 'Merchant on a low balance',
    source: standaloneSource(ids.low, '2'),
    account: accountSnapshot('active', 8, 1, 4),
    freeGrantPresent: true,
  },
  {
    orgId: ids.spent,
    organizationName: 'Merchant out of credits',
    source: standaloneSource(ids.spent, '3'),
    account: accountSnapshot('active', 0, 0, 31),
    freeGrantPresent: true,
  },
  {
    orgId: ids.suspended,
    organizationName: 'Suspended merchant',
    source: standaloneSource(ids.suspended, '4'),
    account: accountSnapshot('suspended', 12, 0, 6),
    freeGrantPresent: true,
  },
  {
    orgId: ids.debt,
    organizationName: 'Refunded merchant in debt',
    source: standaloneSource(ids.debt, '5'),
    account: accountSnapshot('active', -12, 1, 9),
    freeGrantPresent: true,
  },
]
...
function billingSummary(
  row: Omit<CreditAccountRow, 'billing'>
